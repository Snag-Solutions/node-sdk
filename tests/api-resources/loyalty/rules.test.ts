  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.loyalty.rules.create({
      ...
      metadata: {
        ...
        checkText: 'loyalty',
        collection: [
          { address: '0xabcdefabcdefabcdefabcdefabcdefabcdef', multiplier: 2, network: 'abstract' },
        ],
      ...
      collections: [{ address: '0xabcdefabcdefabcdefabcdefabcdefabcdef', network: 'abstract' }],
