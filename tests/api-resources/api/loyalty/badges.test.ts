...
describe('resource badges', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.api.loyalty.badges.create({
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.api.loyalty.badges.create({
      imageUrl: 'https://example.com/image.png',
      name: 'Example Badge',
      organizationId: '123e4567-e89b-12d3-a456-426614174222',
      rules: [
  ...
  test.skip('update', async () => {
    const responsePromise = client.api.loyalty.badges.update('123e4567-e89b-12d3-a456-426614174333');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.api.loyalty.badges.update('123e4567-e89b-12d3-a456-426614174333', {
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.update(
  ...
  test.skip('list', async () => {
    const responsePromise = client.api.loyalty.badges.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.api.loyalty.badges.list({ path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.list(
        {
  ...
  test.skip('delete', async () => {
    const responsePromise = client.api.loyalty.badges.delete('123e4567-e89b-12d3-a456-426614174333');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.delete('123e4567-e89b-12d3-a456-426614174333', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(SnagSolutions.NotFoundError);
  });
  ...
  test.skip('revoke', async () => {
    const responsePromise = client.api.loyalty.badges.revoke('123e4567-e89b-12d3-a456-426614174333');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('revoke: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.revoke('123e4567-e89b-12d3-a456-426614174333', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(SnagSolutions.NotFoundError);
  });
  ...
  test.skip('revoke: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.revoke(
        '123e4567-e89b-12d3-a456-426614174333',
        {
  ...
  test.skip('reward', async () => {
    const responsePromise = client.api.loyalty.badges.reward('123e4567-e89b-12d3-a456-426614174333');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('reward: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.reward('123e4567-e89b-12d3-a456-426614174333', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(SnagSolutions.NotFoundError);
  });
  ...
  test.skip('reward: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.badges.reward(
        '123e4567-e89b-12d3-a456-426614174333',
        {
          userId: '123e4567-e89b-12d3-a456-426614174333',
          walletAddress: '0x1234567890abcdef1234567890abcdef12345678',
