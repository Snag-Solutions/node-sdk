...
describe('resource rules', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.api.loyalty.rules.create({
      amount: '10.5',
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.api.loyalty.rules.create({
      amount: '10.5',
      effectiveEndTime: '2024-12-31T23:59:00Z',
      effectiveStartTime: '2024-01-01T00:00:00Z',
      endTime: '2024-12-31T23:59:00Z',
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.api.loyalty.rules.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      amount: '10.5',
      endTime: '2024-12-31T23:59:00Z',
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.api.loyalty.rules.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      amount: '10.5',
      endTime: '2024-12-31T23:59:00Z',
      name: 'Daily Rewards Program',
      collectionAddress: '0x1234567890abcdef1234567890abcdef12345678',
  ...
  test.skip('list', async () => {
    const responsePromise = client.api.loyalty.rules.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.api.loyalty.rules.list({ path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test.skip('delete', async () => {
    const responsePromise = client.api.loyalty.rules.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.rules.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(SnagSolutions.NotFoundError);
  });
  ...
  test.skip('complete', async () => {
    const responsePromise = client.api.loyalty.rules.complete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('complete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.loyalty.rules.complete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(SnagSolutions.NotFoundError);
  });
  ...
  test.skip('getStatus: only required params', async () => {
    const responsePromise = client.api.loyalty.rules.getStatus({
  ...
  test.skip('getStatus: required and optional params', async () => {
    const response = await client.api.loyalty.rules.getStatus({
      organizationId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      websiteId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
