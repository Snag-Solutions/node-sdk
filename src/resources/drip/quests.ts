...
export class Quests extends APIResource {
   ...
   * Get Drip Quests
   */
  list(query?: QuestListParams, options?: Core.RequestOptions): Core.APIPromise<QuestListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<QuestListResponse>;
  list(
    query: QuestListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<QuestListResponse> {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.get('/api/drip/quests', { query, ...options });
  }
...
export interface QuestListResponse {
  quests: Array<QuestListResponse.Quest>;
}

export namespace QuestListResponse {
  /**
...
export interface QuestListParams {
  /**
   * Filter quests based on claimed status
   */
  isClaimed?: unknown;
